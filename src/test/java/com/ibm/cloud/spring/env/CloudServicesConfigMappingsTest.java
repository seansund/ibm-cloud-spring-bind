 ...
 */
public class CloudServicesConfigMappingsTest {
    ...
    @Before
    public void setUp() {
        System.out.println("Config paths: " + ConfigUtil.listFiles("/mappings"));
        CloudServicesConfigMap.getInstance(ConfigUtil.listFiles("/mappings")).setAppContext(appContext);
